...
public class WiFiDirectServicesList extends ListFragment {
    ...
    public class WiFiDevicesAdapter extends ArrayAdapter<WiFiP2pService> {
        ...
        protected String userID,userStatus;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (service != null) {
                ...
                if (nameText != null) {
                    nameText.setText(userID + " - " + service.instanceName);
                    // nameText.setText(service.device.deviceName +"(" + extraDeviceinfo + ")" + " - " + service.instanceName);
                }
                TextView statusText = (TextView) v
                        .findViewById(android.R.id.text2);

                statusText.setText(getDeviceStatus(service.device.status) + " - " + userStatus);
            }
            return v;
        }
